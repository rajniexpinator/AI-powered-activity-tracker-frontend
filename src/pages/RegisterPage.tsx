      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-[var(--color-surface)] rounded-[var(--radius-lg)] p-6 md:p-8 shadow-[var(--shadow-md)] border border-[var(--color-border)]">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[var(--radius)] text-[14px] placeholder:text-[var(--color-text-secondary)]/70"
            ...
            <div>
              <label htmlFor="name" className="block text-[11px] font-medium text-[var(--color-text-secondary)] mb-1.5 uppercase tracking-wider">
                Name (optional)
              </label>
              <div className="relative">
          ...
          <div className="mt-5 pt-5 border-t border-[var(--color-border)] text-center">
            ...
            <Link to="/login" className="text-[13px] font-medium text-[var(--color-primary)] hover:underline">
              Sign in
            </Link>
          </div>
        </div>
